...
// Source: github.com/luxfi/protocol/p/state (interfaces: StakerIterator)
//
// Generated by this command:
//
//	mockgen -package=state -destination=vms/platformvm/state/mock_staker_iterator.go github.com/luxfi/protocol/p/state StakerIterator
//
